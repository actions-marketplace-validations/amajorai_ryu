...
export const SETTINGS_ENTRIES: SettingsEntry[] = [
	...
	},
	{
		...
		keywords: "zsh bash fish powershell",
	},
	{
	...
	{
		id: "developer.tauri-mcp-bridge.bridge-status",
		dialog: "app",
		section: "developer",
		group: "Tauri MCP bridge",
		label: "Bridge status",
		keywords: "mcp bridge automation",
	},
	{
		id: "developer.tauri-mcp-bridge.agent-connection",
		dialog: "app",
		section: "developer",
		group: "Tauri MCP bridge",
	...
	},
	{
		...
		dialog: "gateway",
		section: "network",
		group: "Mesh (Tailscale / Headscale)",
		label: "Enable mesh",
		keywords: "tailscale headscale vpn tailnet remote",
	},
	{
