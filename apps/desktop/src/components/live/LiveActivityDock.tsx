...
function ActivityCard({
	...
	return (
		...
		>
			...
			{activity.action && (
				<button
					className="mt-1 flex items-center justify-center gap-1 rounded-lg bg-muted/70 py-1.5 text-[11px] font-medium text-foreground transition-colors hover:bg-muted"
