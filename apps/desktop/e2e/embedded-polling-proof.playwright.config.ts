...
export default defineConfig({
	...
	webServer: {
		command:
			"bunx vite build --config ../../../apps-store/warmup/ui/vite.config.ts --outDir /tmp/ryu-warmup-performance-build && bunx vite build --config ../../../apps-store/approvals/ui/vite.config.ts --outDir /tmp/ryu-approvals-performance-build && bunx vite build --config ../../../apps-store/quests/ui/vite.config.ts --outDir /tmp/ryu-quests-performance-build && bunx vite build --config ../../../apps-store/chat-broadcast/ui/vite.config.ts --outDir /tmp/ryu-broadcast-performance-build && bunx vite build --config ../../../apps-store/monitors/ui/vite.config.ts --outDir /tmp/ryu-monitors-performance-build && bunx vite build --config ../../../apps-store/finetune/ui/vite.config.ts --outDir /tmp/ryu-finetune-performance-build && bunx vite build --config ../../../apps-store/video-studio/ui/vite.config.ts --outDir /tmp/ryu-video-performance-build && bunx vite build --config ../../../apps-store/research/ui/vite.config.ts --outDir /tmp/ryu-research-performance-build && bunx vite --config harness/vite.embedded-polling-proof.config.ts",
