...
export const CHAT_KEYMAP: readonly KeymapEntry[] = [
	...
	{ group: "Chat", keys: "Ctrl+Q", label: "focus queued prompts" },
	...
	{ group: "Commands", keys: "/delete", label: "delete a conversation" },
	{
		group: "Commands",
		keys: "/queue",
		label: "inspect and manage queued prompts",
	},
	{ group: "Commands", keys: "/theme", label: "choose the terminal theme" },
	{ group: "Commands", keys: "/help", label: "show command help" },
