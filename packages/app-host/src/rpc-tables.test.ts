...
const OLD_METHOD_CAPABILITY: Record<string, Capability> = {
	...
	"workflows.connectBindings": "workflows.catalogs",
	"workflows.bindConnectTrigger": "workflows.runstate",
	"workflows.removeConnectBinding": "workflows.runstate",
	...
	"activity.audit": "activity.read",
	"activity.prune": "activity.run",
	"activity.score": "activity.run",
	"activity.trace": "activity.read",
	"activity.redteam": "activity.run",
	"activity.eval": "activity.run",
	"activity.importTrace": "activity.run",
