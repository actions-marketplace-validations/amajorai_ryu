...
The single source of UI truth across Ryu's closed surfaces: ~66 React components built on Base UI primitives (NOT Radix), shadcn-style patterns, and Tailwind v4, plus the fixed Ryu App UI v1 stylesheet, shared hooks, theme helpers, and a vendored PlateJS editor.
