...
function useDataGrid<TData>({
	...
	// Base UI's `useDirection()` reads the ambient direction (no override arg,
	// unlike Radix's); honour an explicit `dir` prop when provided.
	const ambientDir = useDirection();
