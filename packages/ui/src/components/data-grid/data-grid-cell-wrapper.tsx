...
import { useDataGridPresence } from "@ryu/ui/components/data-grid/data-grid-presence.tsx";
import { useComposedRefs } from "@ryu/ui/lib/compose-refs.ts";
import { getCellKey } from "@ryu/ui/lib/data-grid.ts";
import { cn } from "@ryu/ui/lib/utils.ts";
import type { DataGridCellProps } from "@ryu/ui/types/data-grid.ts";
import {
	type ComponentProps,
	type CSSProperties,
	type KeyboardEvent,
...
export function DataGridCellWrapper<TData>({
	...
	return (
		<div
			...
			style={
				cellPresence
					? ({ "--tw-ring-color": cellPresence.color } as CSSProperties)
					: undefined
			}
		/>
	);
