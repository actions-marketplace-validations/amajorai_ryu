...
// Adapted to this repo's conventions: `motion/react`, the shared `cn`, and a
// locally-inlined EASE_OUT token. Lives in @ryu/ui so the desktop panels and the
// marketing blocks animate identically instead of drifting apart.
...
function BouncyAccordionRow({
	...
	// Isomorphic: the marketing blocks server-render this component in Next, and
	// a bare useLayoutEffect warns (and does nothing) on the server.
