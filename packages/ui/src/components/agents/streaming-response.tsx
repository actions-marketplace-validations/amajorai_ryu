						...
						<div className={cn("flex items-center gap-0.5", actionsClassName)}>
							...
							{hasSources ? (
								<button
									...
									className="group ml-1 inline-flex min-h-7 items-center gap-2 rounded-md px-1.5 text-muted-foreground text-xs outline-none transition-colors hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring"
