...
import {
	...
	HoverCardContent,
	HoverCardTrigger,
} from "@ryu/ui/components/editor/ui/hover-card.tsx";
import {
	InlineCombobox,
	...
	InlineComboboxInput,
	InlineComboboxItem,
} from "@ryu/ui/components/editor/ui/inline-combobox.tsx";
import {
	Popover,
	PopoverAnchor,
	PopoverContent,
...
export function FootnoteInputElement(props: PlateElementProps) {
	...
	const insertSelectedFootnote = useCallback(
		(identifier: string) => {
