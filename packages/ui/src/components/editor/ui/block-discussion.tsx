...
import type { TDiscussion } from "@ryu/ui/components/editor/plugins/discussion-kit.tsx";
import { suggestionPlugin } from "@ryu/ui/components/editor/plugins/suggestion-kit.tsx";
...
import { useBlockDiscussionItems } from "@ryu/ui/lib/block-discussion-index.ts";
import {
	...
	return (
		<div className="flex w-full justify-between">
			...
			>
				...
				{totalCount > 0 && (
					<div className="relative start-0 size-0 select-none">
						<PopoverTrigger
							render={
								<Button
									className="!px-1.5 ms-1 mt-1 flex h-6 gap-1 py-0 text-muted-foreground/80 hover:text-muted-foreground/80 data-[active=true]:bg-muted"
